...
{
    public class Vacancy3Controller : ApiController
    {
...
//job_type string
        ...
        //public bool CreateVacancy(int userID, string name, string requiredSkills, string beginDate, string endDate, string description, int jobTypeID)
        //{
        //    //return value;
        ...
        //}
        public string CreateVacancy(int userID)
        {
            //return value;
            //Employer userTest = new Employer(1, 1, "name", "test@hotmail.com", "password", 1, new List<SkillType>() { new SkillType(1, "programmer") });
            //Vacancy Vacancy = new Vacancy(userTest, "We zoeken naar programmeur", 1, new List<SkillType>() { new SkillType(1, "programmer") }, "Een geervaarde programmeur", new DateTime(2018, 11, 1), new DateTime(2018, 11, 11), 5);
        ...
        public string Get(int userID, string name, string requiredSkills, string beginDate, string endDate, string description, int jobTypeID)
        {
            return userID+" "+ name + " " + requiredSkills+ " "+ beginDate+ " " + endDate+ " " + description+ " "+jobTypeID;
        }
